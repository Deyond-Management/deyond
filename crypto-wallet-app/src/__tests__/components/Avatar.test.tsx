...
describe('Avatar', () => {
  ...
  describe('Sizes', () => {
    ...
    it('should render small size', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" size="small" testID="avatar" />
      );
      const avatar = getByTestId('avatar');
      expect(avatar.props.style).toMatchObject(
    ...
    it('should render large size', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" size="large" testID="avatar" />
      );
      const avatar = getByTestId('avatar');
      expect(avatar.props.style).toMatchObject(
    ...
    it('should render xlarge size', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" size="xlarge" testID="avatar" />
      );
      const avatar = getByTestId('avatar');
      expect(avatar.props.style).toMatchObject(
  ...
  describe('Badge', () => {
    ...
    it('should render with online badge', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" badgeStatus="online" />
      );
    ...
    it('should render with offline badge', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" badgeStatus="offline" />
      );
      expect(getByTestId('avatar-badge')).toBeDefined();
    });
    ...
    it('should render with busy badge', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" badgeStatus="busy" />
      );
      expect(getByTestId('avatar-badge')).toBeDefined();
    });
  });
  ...
  describe('Border', () => {
    it('should support border', () => {
      const { getByTestId } = renderWithTheme(
        <Avatar name="John" border testID="avatar" />
      );
      const avatar = getByTestId('avatar');
      expect(avatar.props.style).toMatchObject(
