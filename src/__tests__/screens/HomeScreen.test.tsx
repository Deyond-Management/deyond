...
describe('HomeScreen', () => {
  ...
  describe('Rendering', () => {
    it('should render total balance section', () => {
      const { getByText } = renderWithTheme(<HomeScreen navigation={mockNavigation as any} />);
      expect(getByText(/Total Balance/i)).toBeDefined();
    });

    it('should render balance amount', () => {
      const { getByTestId } = renderWithTheme(<HomeScreen navigation={mockNavigation as any} />);
  ...
  describe('Token List', () => {
    ...
    it('should navigate to token details when token card is pressed', () => {
      const { getAllByTestId } = renderWithTheme(<HomeScreen navigation={mockNavigation as any} />);
  ...
  describe('Accessibility', () => {
    it('should have accessible action buttons', () => {
      const { getByLabelText } = renderWithTheme(<HomeScreen navigation={mockNavigation as any} />);
  ...
  describe('Network Selector', () => {
    ...
    it('should display current network name', () => {
      const { getAllByText } = renderWithTheme(<HomeScreen navigation={mockNavigation as any} />);
